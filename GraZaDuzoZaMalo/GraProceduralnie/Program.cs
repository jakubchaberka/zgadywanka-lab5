...

{
...

    {
        ...
        /// <param name="max">Dowolna liczba cąłkowita</param>
        /// <returns></returns>
        ...
        static void Main( string[] args )
        {
            ...
            int min = WczytajDane("Podaj wartosc minimalną do wylosowania: ");
            int max = WczytajDane("Podaj wartosc maksymalną do wylosowania: ");
